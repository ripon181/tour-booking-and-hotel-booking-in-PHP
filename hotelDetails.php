...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO bookhotels (user_id,name, email, phone, address, book_date, amount, bkash_number, transaction_number, status)
            VALUES ('$user_id', '$name', '$email', '$phone', '$address', '$book_date', '$amount', '$bkash_number', '$transaction_number', '$status')";

    if ($conn->query($sql) === TRUE) {
        echo '<script>alert("Hotel Booked Successfull !!!."); window.location.href = "myAccount.php";</script>';
        exit();
    } else {
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM hotels WHERE id = $tourId";
...
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="banner">
            <img src="admin/hotels/<?php echo $image; ?>" alt="<?php echo $title; ?>" class="img-fluid">
            </div>
        </div>
        <div class="col-md-6">
            <div class="content">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bookModalLabel">Book This Hotel</h5>
